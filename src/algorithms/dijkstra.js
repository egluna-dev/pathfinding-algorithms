...
//         if (j === 1) return
//         const val = this.q[j].distance
//         const parentIdx = Math.floor(j / 2)
//         const parentVal = this.q[parentIdx].distance
//         if (val < parentVal) {
...
//             childD = this.q[leftChildIdx].distance 
//         } else {
//             childD = Math.min(this.q[leftChildIdx].distance, this.q[rightChildIdx].distance)
//             childIdx = Math.min(leftChildIdx, rightChildIdx)
//         }

//         if (this.q[j].distance > childD) {
